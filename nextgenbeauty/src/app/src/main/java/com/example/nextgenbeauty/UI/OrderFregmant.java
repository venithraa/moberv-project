...
import com.example.nextgenbeauty.Adapters.OrderAdapter;
import com.example.nextgenbeauty.Model.MyorderModel;
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                if (snapshot.exists()) {
                    for (DataSnapshot dataSnapshot : snapshot.getChildren()) {
                        ...
                        orderItemList.add( new MyorderModel(dataSnapshot.getKey(),"   Date :  " + Date ,"   Products Number :  "+String.valueOf(nums),"   Total Price :  "+ totalPrice+" INR" , "   "+products,OrderCheck));
                    }
                }
                else{
                    orderItemList.clear();
